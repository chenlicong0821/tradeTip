...
codeData = {
    ...
    'sh000932': (17600.745, 23697.68, 'index', -1, 60, 90),  # 中证消费。2020-08-28的MA250为基准价、MA20为目标价
    # 'sz159928': (3.126, 3.804, 'ETF', 20000),  # 中证消费ETF。2020-07-17的MA250为基准价、MA30为目标价
    'sh000913': (12126.877, 16581.43, 'index', -1, 52, 82),  # 300医药。2020-08-28的MA250为基准价、2020-08-18 MA20为目标价
